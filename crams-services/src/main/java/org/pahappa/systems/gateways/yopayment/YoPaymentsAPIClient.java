package org.pahappa.systems.gateways.yopayment;
...
public class YoPaymentsAPIClient {
    ...
    public String createDepositXml(float Amount, String FundsSourcePhone,String Narrative){
     ...
     public String createTransactionStatusCheckXml(String depositTransactionType, String transactionReference,String privateTransactionReference){
        return "<?xml version='1.0' encoding='UTF-8'?>" + 
        "<AutoCreate>" + 
            "<Request>" + 
                "<APIUsername>"+APIUsername+"</APIUsername>" + 
